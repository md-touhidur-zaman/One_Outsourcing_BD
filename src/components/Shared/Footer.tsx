...
export default function Footer() {
  return (
    <footer className=" text-muted-foreground container mx-auto md:border-l md:border-l-muted-foreground md:border-r md:border-r-muted-foreground">
      <div className="  pt-16 pb-8 ">
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32 px-5">
        ...
        <div className="mt-16 border-t border-gray-100 pt-8 dark:border-gray-800">
          <p className="text-center text-xs/relaxed text-gray-500 dark:text-gray-400">
            ...
            <a
              href="#"
              className=" underline transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
            >
              Laravel
            </a>
            and
