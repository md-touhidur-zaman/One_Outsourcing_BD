  ...
  return (
    <>
      <div className="p-10 md:border-l md:border-l-muted-foreground md:border-r md:border-r-muted-foreground flex flex-col-reverse lg:flex-row gap-10 justify-center items-center">
        <div className="lg:w-1/2 flex justify-center lg:-mt-24">
          <div className="relative space-y-2">
            ...
            <div className="md:absolute md:top-32 md:left-16 h-52 w-52 rounded-full bg-black text-white flex justify-center items-center p-2 font-bold">
              Web Design
            </div>
            <div className="md:absolute md:top-60 md:left-36 h-52 w-52 rounded-full bg-yellow-400  flex justify-center items-center p-2 font-bold">
              Digital Marketing
            </div>
          </div>
        </div>
      ...
      <div className="md:border-l md:border-l-muted-foreground md:border-r md:border-r-muted-foreground relative w-full h-60 md:h-80 md:mt-52 lg:mt-0 lg:h-180 ">
        <Image src={"/assets/images/aboutImages/About_Us_Img.png"} alt="about us img" fill style={{objectFit: "fill"}} />
